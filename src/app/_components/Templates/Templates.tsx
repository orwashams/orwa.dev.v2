        ...
        <GridCol span={{ base: 12, md: 6, lg: 4 }}>
          <TemplateCard
            ...
            examples={[
              {
                name: t(
                  "templates.portfolio_website.examples.bruno_simon.name",
                ),
                description: t(
                  "templates.portfolio_website.examples.bruno_simon.description",
                ),
                link: t(
                  "templates.portfolio_website.examples.bruno_simon.link",
                ),
              },
              {
        ...
        <GridCol span={{ base: 12, md: 6, lg: 4 }}>
          <TemplateCard
            ...
            examples={[
              ...
              {
                name: t(
                  "templates.forums_and_communities.examples.reddit.name",
                ),
                description: t(
                  "templates.forums_and_communities.examples.reddit.description",
                ),
                link: t(
                  "templates.forums_and_communities.examples.reddit.link",
                ),
              },
              {
                name: t(
